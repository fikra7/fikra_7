...
MySQL - 10.1.31-MariaDB : Database - fikrabsi22
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fikrabsi22` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `jadwal mengajar dosen` (
  `Kode Dosen` varchar(3) COLLATE latin1_spanish_ci NOT NULL,
  `Nama Dosen` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `Hari` char(10) COLLATE latin1_spanish_ci DEFAULT NULL,
  `Jam Mengajar` time(5) DEFAULT NULL,
  `Kelas` varchar(10) COLLATE latin1_spanish_ci DEFAULT NULL,
